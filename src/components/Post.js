...
const Post = ({title, description, date, tags, className}) => {
  const wrapper = classNames("w-full h-32 transition-shadow shadow hover:shadow-lg border-l-8 border-red-800 rounded-xl p-4 flex flex-row justify-between", className)
